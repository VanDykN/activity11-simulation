...
```
    ...
    ## Warning in mean.default(norm_samp_30): argument is not numeric or logical:
    ## returning NA
...
![](activity11-simulation_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
    ...
    ##   distribution      mean    sd
    ##   <chr>            <dbl> <dbl>
    ## 1 mean_binomial    25.0  0.376
    ## 2 mean_exponential  5.01 0.443
    ## 3 mean_normal      50.0  0.770
    ## 4 mean_uniform     15.0  0.236
